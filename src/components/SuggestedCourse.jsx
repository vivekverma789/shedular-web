  ...
  return (
    <div className="container mx-auto p-4 md:px-[4rem] lg:px-[4rem] animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-[3rem]">
        <ScheduleCard schedule={customSchedule} isPrimary={true} index={0} onPurchase={handlePurchase} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-[3rem]">
        {similarSchedules.map((schedule, idx) => (
          <ScheduleCard key={idx} schedule={schedule} index={idx + 1} onPurchase={handlePurchase} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-[3rem]">
        {otherExams.map((schedule, idx) => (
          <ScheduleCard key={idx} schedule={schedule} index={idx + 5} onPurchase={handlePurchase} />
        ))}
      </div>
    </div>
  );
